...
class Homepage(models.Model):
  ...
  summary = models.CharField(max_length=2000, help_text="Resumo", blank=True, null=True)
...
class Post(models.Model):
  ...
  plain_text = models.CharField(max_length=255, help_text="Conteúdo em texto")
  markdown_text = models.CharField(max_length=255, help_text="Conteúdo em markdown")
...
class Project(models.Model):
  ...
  description = models.CharField(max_length=2000, help_text="Descrição do projeto")
...
class ProjectLink(models.Model):
  ...
  icon = models.CharField(max_length=2000, help_text="Classe do icone do link")
  url = models.CharField(max_length=255, help_text="Url de destino do link")
  ...
  def __str__(self):
    return f"{self.name} on #{self.project} (Show: {self.show})"
